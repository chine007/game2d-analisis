...
//	String N2_PUZZLE_TIMEOUT 							= "puzzle_timeout";
	...
	String[] LEVEL2_NODES_VALUES						= new String[] {"low", "medium", "high"};

	/** Valores de los nodos de la red */
	String[] LEVEL1_NODES_VALUES						= new String[] {"low", "medium", "high"};
	
	/** Valores del nodo raiz */
	String[] FELDER_VALUES 								= new String[] {"intuitive", "neutral", "sensitive"};

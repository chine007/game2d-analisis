...
public class GenieNetworkBuilder {
	...
	public Network buildNetwork() {
		...
		addNode(net, N0_ROOT, N1_ABSTRACTION, LEVEL1_NODES_VALUES);
...
//		addNode(net, N1_COMPLEXITY, N2_PUZZLE_HELP, NODES_VALUES);
//		addNode(net, N1_COMPLEXITY, N2_PUZZLE_TIMEOUT, NODES_VALUES);
		...
		addNode(net, N1_ABSTRACTION, N2_ABSTRACT_LEVELS_WON, LEVEL2_NODES_VALUES);
		addNode(net, N1_ABSTRACTION, N2_ABSTRACT_MAX_LEVEL, LEVEL2_NODES_VALUES);
